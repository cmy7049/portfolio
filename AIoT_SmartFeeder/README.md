...
국립부경대학교 공과대학 공학교육혁신센터 주관, AIoT 스마트 디바이스 설계 프로젝트 "IoT Invent-on"에서 제작한 프로젝트입니다.
YOLOv11 객체 인식 기반 스마트 자동 급식기를 3D 모델링하고 시스템을 구현했습니다.

**장려상 수상** (부경대학교 공학교육혁신센터)
...
- 본인 : 기구물 3D 모델링(Onshape), 아두이노(MCU) 구동부 및 센서 제어 및 배선 설계
